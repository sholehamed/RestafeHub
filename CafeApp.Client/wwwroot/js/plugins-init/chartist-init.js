 ...
 var dzChartlist = function(){
	...
	var svgAnimationChart = function(){
		...
		var chart = new Chartist.Line('#svg-animation', {
			labels: ['شنبه', 'یک شنبه', 'دو شنبه', 'سه شنبه', 'چهار شنبه', 'پنج شنبه'],
			series: [
			  [1, 5, 2, 5, 4, 3],
			  [2, 3, 4, 8, 1, 2],
			  [5, 4, 3, 2, 1, 0.5]
	...
	var biPolarBarChart = function(){
		//Bi-polar bar chart
		var data = {
			labels: ['یک هفته', 'دو هفته', 'سه هفته', 'چهار هفته', 'پنج هفته', 'شش هفته', 'هفت هفته', 'هشت هفته', 'نه هفته', 'ده هفته'],
			series: [
			  [1, 2, 4, 8, 6, -2, -1, -4, -6, -2]
			]
		};
	...
	var overlappingBarsChart = function(){
		...
		var data = {
			labels: ['فروردین', 'اردی', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'],
			series: [
